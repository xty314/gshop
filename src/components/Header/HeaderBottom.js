             ...
             z" />
              ...
              <div className="nav-panel__nav-links nav-links">
                <ul className="nav-links__list">
                  ...
                  <li className="nav-links__item nav-links__item--with-submenu"><a href="shop-grid-3-columns-sidebar.html"><span>Category <svg className="nav-links__arrow" width="9px" height="6px">
                  ...
                  <li className="nav-links__item"><a href="contact-us.html"><span>Contact
                        Us</span></a></li>
                  <li className="nav-links__item"><a href="https://themeforest.net/user/kos9/portfolio"><span>Buy
                        Theme</span></a></li>
                </ul>
              </div>{/* .nav-links / end */}
